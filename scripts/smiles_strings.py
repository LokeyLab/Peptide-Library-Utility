"""
This script is not used in the program, but rather, just holds the SMILES strings of the canonical amino acids which
had to be rearranged from their original form that was taken from Pub Chem. The Pub Chem version is commented next to
each amino acid.

Standardized format: α-amine group | carbon atom C2 | ( side chain ) | α-carboxyl group
Taken from: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6149970/
